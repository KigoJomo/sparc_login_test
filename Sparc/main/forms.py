...
from .models import CustomUser, Course, Task, Unit, Session
...
class SessionCreateForm(forms.ModelForm):
    session_duration_mins = forms.IntegerField()
    session_duration_sec = forms.IntegerField()

    class Meta:
        model = Session
        fields = ('session_duration_mins','session_duration_sec',)

class FocusSettingsForm(forms.ModelForm):
    focus_period = forms.IntegerField()
    break_duration = forms.IntegerField()
    daily_goal = forms.IntegerField()

    class Meta:
        model = CustomUser
        fields = ('focus_period', 'break_duration', 'daily_goal',)
